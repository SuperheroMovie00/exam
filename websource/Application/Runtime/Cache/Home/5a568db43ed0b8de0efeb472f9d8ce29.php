     ...
     <table border="0" cellspacing="0" cellpadding="0" class="pub-table-par">
        ...
        <!--   </tr>-->
           ...
           <tr class="even">
               ...
               <td><?php echo get_table_Question_type("$search[type]","name","") ; ?></td>
               <th>小题数量</th>
               <td><?php echo $search["childs"]?$search["childs"]:""; ?></td>
               <th>创建时间</th>
          ...
          <tr class= "even">
              ...
              <th>引用次数</th>
              <td><?php echo $search["using"]?$search["childs"]:""; ?></td>
              <th>状态</th>
             ...
             <input type="hidden" name="_tab_showview2_psize" value="<?php echo $search["_tab_showview2_psize"]; ?>" />
                  ...
                  <div class="order-det-ptab">
                    <div class="od-info abe-fl" >
                      ...
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'shijuanmingxi');" <?php if($search['_tab'] == 'shijuanmingxi'): ?> class="current"<?php endif;?>>试题引用</a>
...
<?php } ?>
   ...
   <div class="data-oper" >
      ...
      <div class="data-oper-in " >
          ...
          <?php if ($search['status']==0): ?>
               <input type="button" value="试题编辑" class="btn btn-blue mlg_10" default-status="1" onclick="return _asr.popupFun('<?php echo U("/Home/Question/index?func=edit_base&id=$search[id]") ; ?>', '<?php echo filterFuncId("/Home/Question/index?func=edit_base&id=
               ","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
