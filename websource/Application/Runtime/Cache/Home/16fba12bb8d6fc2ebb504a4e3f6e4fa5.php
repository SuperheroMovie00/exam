...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('Exam/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>试卷信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form enctype="multipart/form-data" action="<?php echo U('Exam/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="post">
          ...
          <ul class="form form-mod-new form-column2">
              <li>
                  <div class="unit-left"><span class="tit"> 试卷编码<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                      <div class="textbox">
              ...
              <li>
                  <div class="unit-left"><span class="tit"> 模板编码</span></div>
                  <div class="unit-mid">
                      <div class="textbox">
                          <label  class="pbtxt txt0" name="templet_no"  ><?php echo $search['templet_no']; ?>  </label>
                      </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
              ...
              <li class="per100">
                  <div class="unit-left"><span class="tit"> 试卷名称<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                      <div class="textbox">
 ...
 $keyvalue = table_Exam_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
             ...
             <li>
                  ...
                  <div class="unit-mid">
                       <div class="textbox">
                           <label type="text" disabled="true" class="pbtxt txt0" name="count"  value=""  ><?php echo $search['count']; ?></label>
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
             ...
             <li>
                  ...
                  <div class="unit-mid">
                       <div class="textbox">
                           <label type="text" disabled="true" class="pbtxt txt0" name="score"  value=""  ><?php echo $search['score']; ?></label>
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
    ...
    <div class="pop-sub abe-txtc" >
               ...
               <input type="button" value="提交" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Exam/index?func=save&id=$search[id]") ; ?>',''); " />
