...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('User/index'); ?>">

   <div class="title">
       <span class="pop-name"><?php echo $search[id]?'编辑':'新增'; ?>用户信息</span>
...
<div class="pop-scroll">
   <div class="screening ">
      <form action="<?php echo U('User/index?func=save'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
          ...
          <ul class="form form-mod-new form-column2">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 用户<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 姓名<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
                       <div class="textbox">
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 选择性别<em class="abe-red mrg_5">*</em></span></div>
                  <div class="unit-mid">
 ...
 $keyvalue = table_User_sex(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                 ...
                                 <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['sex']): ?> selected="selected" <?php endif;?>><?php echo $item['name']; ?></option>
                                    <?php endforeach; ?>
                             <?php } ?>
                           </select>
                       </div>
             ...
             <li>
                  ...
                  <div class="unit-mid">
                       <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="mobilephone"  value="<?php echo $search['mobilephone']; ?>"  >
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 登入密码</span></div>
                  <div class="unit-mid">
                       <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="passwordsource"  value="<?php echo $search['passwordsource']; ?>"  >
                       </div>
                      <div class="prompt" style="display:none">
                          <div class="error"><i class="iconfont">&#xe616;</i></div>
                      </div>
             ...
             <li>
                  <div class="unit-left"><span class="tit"> 是否管理员</span></div>
                  <div class="unit-mid">
                       <div class="dropdown" id="<?php echo ($funcid); ?>_superadmin">
                           <select class="pbsele dropdown0" name="superadmin">
                             <?php
 $keyvalue = table_User_superadmin(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                    <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                 <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['superadmin']): ?> selected="selected" <?php endif;?>><?php echo $item['name']; ?></option>
                                    <?php endforeach; ?>
                             <?php } ?>
                           </select>
                       </div>
                  ...
                  <div class="unit-mid">
                       <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           <select class="pbsele dropdown0" name="status">
                             ...
                             <?php
 $keyvalue = table_User_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                    <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
    ...
    <div class="pop-sub abe-txtc" >
               <input type="button" value="保存" class="btn btn-org mrg_10 " default-status="1" onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/User/index?func=save&id=$search[id]") ; ?>',''); " />
   ...
   function <?php echo $funcid;?>_callback(param){
    ...
    <?php echo W('Summary/javascript',array('User'));?>
