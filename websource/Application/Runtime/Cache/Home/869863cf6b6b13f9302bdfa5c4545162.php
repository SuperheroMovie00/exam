...
<div toplayer="1" class="prompt-pop" style="z-index: <?php echo ($zindex); ?>;" id="<?php echo $funcid;?>"  funcid="<?php echo ($funcid); ?>" last-url="<?php echo ($__last_url); ?>">
   ...
   <div class="title">
       <span class="pop-name">组卷模板数据导入</span>
    ...
    <form action="<?php echo U('/Home/Templet/index?func=import&close=1');?>" method="post" id="<?php echo $funcid;?>-Templet-import-Form" enctype="multipart/form-data">
    ...
    <ul class="pbform">
        <li>
            <span class="tit">
            <em class="abe-red mrg_5"></em>组卷模板文件
            </span>
            <div class="txt-box">
        ...
        <li>
            <span class="tit">
            <em class="abe-red mrg_5"></em>组卷模板模板
            </span>
            <div class="txt-box">
                <a href="/Public/importTpl/templet.csv">点击下载</a>
            </div>
        </li>
    </ul>

    <div class="pop-sub abe-txtc">
        <input type="submit" value="提交" class="btn btn-blue mrg_10" onclick="return _asr.submit('<?php echo $funcid;?>', '<?php echo $funcid;?>-Templet-import-Form', '<?php echo U('/Home/Templet/index?func=import_save&close=1');?>',2,'','请确认是否开始数据导入?');">
