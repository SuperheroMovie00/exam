...
<div toplayer="1" class="prompt-pop pop-style3" style="z-index:<?php echo ($zindex); ?>;width:800px;" id="<?php echo $funcid;?>" url="<?php echo U('Templet/index'); ?>">

    <div class="title">
        <span class="pop-name">拷贝组卷模板信息</span>
        ...
        <div class="screening ">
            ...
            <ul class="form form-mod-new form-column2">
                ...
                <li style="display: none">
                    <div class="unit-left"><span class="tit"> 模板类型<em class="abe-red mrg_5">*</em></span></div>
                    <div class="unit-mid">
                        <div class="dropdown" id="<?php echo ($funcid); ?>_type">
                            <select class="pbsele dropdown0" name="type" id="titletype">
 ...
 $keyvalue = table_Templet_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                ...
                <li>
                    <div class="unit-left"><span class="tit"> 模板编码<em class="abe-red mrg_5">*</em></span></div>
                    <div class="unit-mid">
                        <div class="textbox">
                            <input type="text" class="pbtxt txt0" name="templet_no"   >
                            <input type="text" style="display: none" class="pbtxt txt0" name="templet_no_old"  value="<?php echo $search['templet_no']; ?>"  >
                ...
                <li class="per100">
                    <div class="unit-left"><span class="tit"> 模板标题</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
               ...
               <li style="display: none">
                    <div class="unit-left"><span class="tit"> 试卷题量</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
                ...
                <li style="display: none">
                    <div class="unit-left"><span class="tit"> 试卷总分</span></div>
                    <div class="unit-mid">
                        <div class="textbox">
    ...
    <div class="pop-sub abe-txtc" >
        ...
        <input type="button" value="拷贝" class="btn btn-blue mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("/Home/Templet/index?func=copy_templet_save&id=$search[id]") ; ?>',''); " />
