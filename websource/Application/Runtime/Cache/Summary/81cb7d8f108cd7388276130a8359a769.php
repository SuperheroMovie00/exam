    ...
    <div class="screening"  >
      <form action="<?php echo U('SubcodeSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                ...
                <ul class="form form-mod-new" id="<?php echo $funcid;?>-search-Info">
                  ...
                  <li>
                      <div class="unit-left"> 父层</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="parent_id"  value="<?php echo $search['parent_id']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["parent_id"]) && $colshow["parent_id"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">分类</th>
                          <th <?php if(isset($colshow["parent_id"]) && $colshow["parent_id"]=="0"): ?> style="display:none" <?php endif; ?>>父层</th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list; if( count($__LIST__) == 0) : echo ""; else: foreach($__LIST__ as $key=>$master): $mod = ($i % 2 );++$i; ?>
                                  ...
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><?php echo $master["type"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["parent_id"]) && $colshow["parent_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["parent_id"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["code"]) && $colshow["code"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Subcode/index?func=view&id=$master[id]"); ?>','<?php echo filterFuncId( U("/Home/Subcode/index?func=view&id=$master[id]") ,"");?>', '<?php echo tabTitle("系统","$master[code]") ; ?>' ,0); " ><?php echo $master["code"] ; ?></a></td>
                                  <td style=" <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><?php echo $master["name"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["value"]) && $colshow["value"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><div class="newline"><?php echo OverView($master["value"],100,"...") ; ?></div></td>
