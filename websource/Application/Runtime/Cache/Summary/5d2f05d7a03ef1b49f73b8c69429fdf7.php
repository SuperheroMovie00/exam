...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="RoleNodeSummary" baseurl="<?php echo U('RoleNodeSummary/index'); ?>">
  <div class="wrap-box-info ">
    ...
    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">角色模块关系列表</div>
      <div class="abe-fl">
        <div class="textbox" >
 ...
 $keyvalue = table_Role(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="node_name"  value="<?php echo $search['node_name']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="title"  value="<?php echo $search['title']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="module"  value="<?php echo $search['module']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           <col style="width: 80px ; <?php if(isset($colshow["role_id"]) && $colshow["role_id"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["node_name"]) && $colshow["node_name"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["title"]) && $colshow["title"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["level"]) && $colshow["level"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["module"]) && $colshow["module"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list; if( count($__LIST__) == 0) : echo ""; else: foreach($__LIST__ as $key=>$master): $mod = ($i % 2 );++$i; ?>
                                  ...
                                  <td style=" <?php if(isset($colshow["title"]) && $colshow["title"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><?php echo $master["title"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["level"]) && $colshow["level"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["level"] ; ?></td>
                                  <td style=" <?php if(isset($colshow["module"]) && $colshow["module"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><?php echo $master["module"] ; ?></td>
                                 <td></td>
                              </tr>
                              <?php endforeach; ?>
                              <?php
