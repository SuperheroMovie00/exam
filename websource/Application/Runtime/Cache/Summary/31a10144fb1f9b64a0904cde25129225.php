      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["mainkey"]) && $colshow["mainkey"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["subkey"]) && $colshow["subkey"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["seqno"]) && $colshow["seqno"]=="0"): ?>display:none;<?php endif; ?> ">
