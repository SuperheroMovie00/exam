...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="RoleUserSummary" baseurl="<?php echo U('RoleUserSummary/index'); ?>">
  <div class="wrap-box-info ">
    ...
    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">角色用户关系列表</div>
      <div class="abe-fl">
        <div class="textbox" >
 ...
 $keyvalue = table_Role(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                  ...
                  <li>
                      <div class="unit-left"> 选择用户</div>
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_user_id">
                             <select class="pbsele dropdown0" name="user_id">
                                <option value="" <?php if($search['user_id'] == ''): ?> selected="selected" <?php endif;?> ></option>
                               <?php
 $keyvalue = table_User(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                                   <option value="<?php echo $item['id']; ?>" <?php if($item['id'] == $search['user_id']): ?> selected="selected" <?php endif;?>><?php echo charlevel($item['level']).$item['name']; ?></option>
                                      <?php endforeach; ?>
                               <?php } ?>
                             </select>
                          </div>
      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["user_id"]) && $colshow["user_id"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list; if( count($__LIST__) == 0) : echo ""; else: foreach($__LIST__ as $key=>$master): $mod = ($i % 2 );++$i; ?>
                                  ...
                                  <td style=" <?php if(isset($colshow["user_id"]) && $colshow["user_id"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_User_byID("$master[user_id]","name","") ; ?></td>
                                 <td></td>
                              </tr>
                              <?php endforeach; ?>
                              <?php
