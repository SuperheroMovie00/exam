...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="ExamSummary" baseurl="<?php echo U('ExamSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">试卷列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("ExamSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("ExamSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
    ...
    <div class="screening"  >
      <form action="<?php echo U('ExamSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                             <select class="pbsele dropdown0" name="status">
                               ...
                               <?php
 $keyvalue = table_Exam_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_type">
                             <select class="pbsele dropdown0" name="type">
                               ...
                               <?php
 $keyvalue = table_Exam_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                  ...
                  <li>
                      <div class="unit-left"> 题量</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="count"  value="<?php echo $search['count']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="count2" value="<?php echo $search['count2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 时间要求/分钟</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt1" name="req_time"  value="<?php echo $search['req_time']; ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt txt1" name="req_time2" value="<?php echo $search['req_time2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <div class="sub-box sub-box3">
                    <div class="pbtab abe-fl" >
                      ...
                      <a href="#" onclick="return _asr.tabsheet('<?php echo $funcid;?>', '<?php echo "$funcid"; ?>-Search', 'queren');" <?php if($search['_tab'] == 'queren'): ?> class="current"<?php endif;?>>确认</a>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("ExamSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("ExamSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/ExamSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/ExamSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('ExamSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["count"]) && $colshow["count"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["score"]) && $colshow["score"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 120px ; <?php if(isset($colshow["req_time"]) && $colshow["req_time"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["count"]) && $colshow["count"]=="0"): ?> style="display:none" <?php endif; ?>>题量</th>
                          <th <?php if(isset($colshow["score"]) && $colshow["score"]=="0"): ?> style="display:none" <?php endif; ?>>总分</th>
                          <th <?php if(isset($colshow["req_time"]) && $colshow["req_time"]=="0"): ?> style="display:none" <?php endif; ?>>时间要求(分钟)</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Exam/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Exam/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("试卷","$master[exam_no]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php if ($master['status']==0): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.popupFun('<?php echo U("/Home/Exam/index?func=edit&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Exam/index?func=edit&id=$master[id]","");?>'); "><i class="iconfont abe-ft15">&#xe63f;</i></a>
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']==0): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.confirm('确认操作', '请确认是否删除试卷?', '<?php echo "试卷 : $master[exam_no]"; ?>', '<?php echo U("/Home/Exam/index?func=delete&type=1&id=$master[id]") ; ?>','',''); "><i class="iconfont vi-red">&#xe61d;</i></a>
          <?php endif; ?>
          <?php endif; ?>
               ...
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.loadData( '<?php echo "$funcid"; ?>' ,'<?php echo U("ExamSummary/index?func=detail&id=$master[id]") ; ?>',this, 'detail' ); "><i class="iconfont abe-ft18">&#xe61e;</i></a></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Exam_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["exam_no"]) && $colshow["exam_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Exam/index?func=view&id=$master[id]"); ?>','<?php echo filterFuncId( U("/Home/Exam/index?func=view&id=$master[id]") ,"");?>', '试卷详情' ,0); " ><?php echo $master["exam_no"] ; ?></a></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Exam_type("$master[type]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["subject"]) && $colshow["subject"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><div class="newline newline-l"><?php echo OverView($master["subject"],100,"...") ; ?></div></td>
                                  <td style=" <?php if(isset($colshow["count"]) && $colshow["count"]=="0"): ?>display:none<?php endif; ?> " class=" <?php if ($master['count']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["count"],1) ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["req_time"]) && $colshow["req_time"]=="0"): ?>display:none<?php endif; ?> " class=" <?php if ($master['req_time']<0): ?> abe-red <?php endif; ?> "><?php echo system_format("N3", $master["req_time"],1) ; ?></td>
    ...
    <?php echo W('Summary/javascript',array('ExamSummary'));?>
