...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="TestxSummary" baseurl="<?php echo U('TestxSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">测试表111列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TestxSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TestxSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
      ...
      <div class="abe-fr">
        <a href="javascript:void(0);" class="mrg_15 vi-blue search-hide" <?php if($search["_showsearch"]=="hide"):?>style="display:none;"<?php endif; ?>><i class="iconfont">&#xe673;</i>收起搜索</a>
          ...
          <?php if (isset($rights['add']) && $rights['add']): ?>
               <input type="button" value="新增测试表111" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Testx/index?func=add&") ; ?>', '<?php echo filterFuncId("/Home/Testx/index?func=add&","");?>'); " />
          <?php endif; ?>



          <?php if (isset($rights['import']) && $rights['import']): ?>
               <input type="button" value="数据导入" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Testx/index?func=import&") ; ?>', '<?php echo filterFuncId("/Home/Testx/index?func=import&","");?>'); " />
          <?php endif; ?>
    ...
    <div class="screening"  >
      <form action="<?php echo U('TestxSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                           ...
                           <?php $keyvalue = table_Testx_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_type">
                             <select class="pbsele dropdown0" name="type">
                               ...
                               <?php
 $keyvalue = table_Testx_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="testx_no"  value="<?php echo $search['testx_no']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="popup">
                              ...
                              <button type="submit" class="txt-search" onclick="return _asr.popup('QuestionCategory','<?php echo "$funcid"; ?>','<?php echo "$funcid"; ?>-Search','Single','category_code','category_code_name'); " <?php if($search["category_code_name"]!=""): ?> style="display:none"<?php endif; ?> ><i class="iconfont">&#xe60e;</i></button>
                  ...
                  <li>
                      <div class="unit-left"> 导入时间</div>
                      <div class="unit-mid">
                          <div class="calendar">
                              <input type="text" class="pbtxt calendar1" name="import_time"  value= "<?php echo system_format("DT", $search["import_time"],0); ?>"  >
                              <em class="space-line">-</em>
                              <input type="text" class="pbtxt calendar1" name="import_time2" value="<?php echo $search['import_time2']; ?>"  >
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
                  ...
                  <li>
                      <div class="unit-left"> 导入人员</div>
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="import_user"  value="<?php echo $search['import_user']; ?>"   placeholder=" 输入%可进行匹配模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TestxSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TestxSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/TestxSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/TestxSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('TestxSummary/op'); ?>" method="post">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["testx_no"]) && $colshow["testx_no"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 100px ; <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 100px ; <?php if(isset($colshow["category_name"]) && $colshow["category_name"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 100px ; <?php if(isset($colshow["img"]) && $colshow["img"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 150px ; <?php if(isset($colshow["import_time"]) && $colshow["import_time"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["import_user"]) && $colshow["import_user"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["testx_no"]) && $colshow["testx_no"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">编码</th>
                          ...
                          <th <?php if(isset($colshow["img"]) && $colshow["img"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">图像</th>
                          <th <?php if(isset($colshow["import_time"]) && $colshow["import_time"]=="0"): ?> style="display:none" <?php endif; ?>>导入时间</th>
                          <th <?php if(isset($colshow["import_user"]) && $colshow["import_user"]=="0"): ?> style="display:none" <?php endif; ?>>导入人员</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Testx/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Testx/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("题库","$master[testx_no]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php endif; ?>
               ...
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.loadData( '<?php echo "$funcid"; ?>' ,'<?php echo U("TestxSummary/index?func=detail&id=$master[id]") ; ?>',this, 'detail' ); "><i class="iconfont abe-ft18">&#xe61e;</i></a></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Testx_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Testx_type("$master[type]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["testx_no"]) && $colshow["testx_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Question/index?func=view&no=$master[testx_no]"); ?>','<?php echo filterFuncId( U("/Home/Question/index?func=view&no=$master[testx_no]") ,"");?>', '题库详情' ,0); " ><?php echo $master["testx_no"] ; ?></a></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["img"]) && $colshow["img"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><?php if($master["img"]): ?><a href="<?php echo $master["img"] ;?>" target="_blank" class="vi-blue"   >图像</a><?php endif; ?></td>
                                  <td style=" <?php if(isset($colshow["import_time"]) && $colshow["import_time"]=="0"): ?>display:none<?php endif; ?> " ><?php echo system_format("DT", $master["import_time"],1) ; ?></td>
                                  <td style=" <?php if(isset($colshow["import_user"]) && $colshow["import_user"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["import_user"] ; ?></td>
          ...
          <?php if ($master['status']=='0'): ?>
               <input type="button" value="转有效" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Testx/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Testx/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="转无效" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Testx/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Testx/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
    ...
    <script>
        ...
        function <?php echo $funcid; ?>_clearsearch(_frm){
            ...
            _asr.setvaluebyname(_frm,"testx_no","");
            ...
            _asr.setvaluebyname(_frm,"import_time","");
            _asr.setvaluebyname(_frm,"import_time2","");
            _asr.setvaluebyname(_frm,"import_user","");
    ...
    <?php echo W('Summary/javascript',array('TestxSummary'));?>
