      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["order_no"]) && $colshow["order_no"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 100px ; <?php if(isset($colshow["subject"]) && $colshow["subject"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["details"]) && $colshow["details"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["qty"]) && $colshow["qty"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 80px ; <?php if(isset($colshow["amount"]) && $colshow["amount"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["qty"]) && $colshow["qty"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtr">数量(件)</th>
