      ...
      <form action="<?php echo U('RoleSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                ...
                <ul class="form form-mod-new" id="<?php echo $funcid;?>-search-Info">
                  ...
                  <li>
                      ...
                      <div class="unit-mid">
                          <div class="textbox">
                              <input type="text" class="pbtxt txt0" name="remark"  value="<?php echo $search['remark']; ?>"   placeholder=" 直接进行模糊搜索 ">
                          </div>
                          <div class="prompt" style="display:none">
                              <div class="error"><i class="iconfont">&#xe616;</i></div>
                          </div>
      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 80px ; <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?>display:none;<?php endif; ?> ">
                           <col style="width: 100px ; <?php if(isset($colshow["remark"]) && $colshow["remark"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?> style="display:none" <?php endif; ?>>角色</th>
                          <th <?php if(isset($colshow["newcolumn"]) && $colshow["newcolumn"]=="0"): ?> style="display:none" <?php endif; ?>>权限设置</th>
                          <th <?php if(isset($colshow["remark"]) && $colshow["remark"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">备注</th>
                          <th>状态调整</th>
                           <th></th >
                        </tr>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Role/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Role/index?func=view&id=$master[id]"),"");?>' , '角色查看' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php endif; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["name"]) && $colshow["name"]=="0"): ?>display:none<?php endif; ?> " ><?php echo $master["name"] ; ?></td>
          ...
          <?php endif; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["remark"]) && $colshow["remark"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><div><?php echo OverView($master["remark"],100,"...") ; ?></div></td>
                                  <td>


          <?php if (isset($rights['status_on']) && $rights['status_on']): ?>
          <?php if ($master['status']=='0'): ?>
               <input type="button" value="转有效" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Role/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Role/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="转无效" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Role/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/Role/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
