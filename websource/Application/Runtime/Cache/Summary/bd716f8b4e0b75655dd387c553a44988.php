...
<div toplayer="1" class="wrap-box wrap-nmd wrap-style00 " id="<?php echo $funcid;?>" summaryid="TempletSummary" baseurl="<?php echo U('TempletSummary/index'); ?>">
  <div class="wrap-box-info ">

    <div class="wrap-title abe-ofl">
      <div class="tit abe-fl" style="width: 450px;">组卷模板列表</div>
      <div class="abe-fl">
        <div class="textbox" >
          <div  id="<?php echo "$funcid"; ?>-keyword-info" class="abe-fl"<?php if($search["_showsearch"]=="show"):?>style="display:none;"<?php endif; ?>>
             ...
             <input type="button" value="搜索" class="btn btn-org  mrg_10 " id="<?php echo $funcid;?>-keyword-search"  default-status="1"  onclick="<?php echo ($funcid); ?>_keyword_set(); return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TempletSummary/index?func=search&") ; ?>',''); " />
             <input id="<?php echo $funcid;?>-search-buttc" type="button" value="导出" class="btn btn-blue mrg_10 " default-status="1" onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TempletSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          </div>
      ...
      <div class="abe-fr">
        <a href="javascript:void(0);" class="mrg_15 vi-blue search-hide" <?php if($search["_showsearch"]=="hide"):?>style="display:none;"<?php endif; ?>><i class="iconfont">&#xe673;</i>收起搜索</a>
          ...
          <?php if (isset($rights['add']) && $rights['add']): ?>
               <input type="button" value="新增组卷模板" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Templet/index?func=add&") ; ?>', '<?php echo filterFuncId("/Home/Templet/index?func=add&","");?>'); " />
          <?php endif; ?>



          <?php if (isset($rights['import']) && $rights['import']): ?>
               <input type="button" value="数据导入" class="btn btn-blue mrg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/Templet/index?func=import&") ; ?>', '<?php echo filterFuncId("/Home/Templet/index?func=import&","");?>'); " />
          <?php endif; ?>
    ...
    <div class="screening"  >
      <form action="<?php echo U('TempletSummary/index?func=search'); ?>" id="<?php echo "$funcid"; ?>-Search" method="get">
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_status">
                             <select class="pbsele dropdown0" name="status">
                               ...
                               <?php
 $keyvalue = table_Templet_status(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                      ...
                      <div class="unit-mid">
                          <div class="dropdown" id="<?php echo ($funcid); ?>_type">
                             <select class="pbsele dropdown0" name="type">
                               ...
                               <?php
 $keyvalue = table_Templet_type(); if(is_array($keyvalue)){ $i = 0; $__LIST__ = $keyvalue; ?>
                                      <?php foreach($__LIST__ as $key=>$item): ++$i; ?>
          ...
          <?php if (isset($rights['search']) && $rights['search']): ?>
               <input type="button" value="搜索" class="btn btn-org  mrg_10 " onclick="return _asr.submit('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TempletSummary/index?func=search&") ; ?>',''); " />
          <?php endif; ?>
          ...
          <?php if (isset($rights['export']) && $rights['export']): ?>
               <input type="button" value="导出" class="btn btn-blue mrg_10 " onclick="return _asr.showExport('<?php echo "$funcid"; ?>', '<?php echo "$funcid"; ?>-Search', '<?php echo U("TempletSummary/index?func=export&") ; ?>',<?php echo $p ?>); " />
          <?php endif; ?>

                    <em class="pdr_20"></em>
                    <a href="javascript:void(0);" class="table-set <?php echo count($colshow)>0?"vi-blue":"abe-gray3"; ?>"  onclick="return _asr.popupFun('<?php echo U("/Summary/TempletSummary/index?func=columnsetting&") ; ?>','<?php echo filterFuncId("/TempletSummary/column","");?>');  " ><em class="iconfont abe-ft14 mrg_5">&#xe60a;</em>设置</a>
                    </div>
                  </div>
      </form>
    </div>
  ...
  <div class="wrap-nmd-box">
    <div class="wrap-master ">
      ...
      <div class="list-scroll">
        <div class="table-box">
          <div class="table-in">
            <form id="<?php echo "$funcid"; ?>-Result"  action="<?php U('TempletSummary/op'); ?>" method="post">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["templet_no"]) && $colshow["templet_no"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">编码</th>
          ...
          <?php if (isset($rights['master_view']) && $rights['master_view']): ?>
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.openLink('<?php echo U("/Home/Templet/index?func=view&id=$master[id]") ; ?>', '<?php echo filterFuncId(U("/Home/Templet/index?func=view&id=$master[id]"),"");?>' , '<?php echo tabTitle("组卷模板","$master[templet_no]") ; ?>' ,0); "><i class="iconfont abe-ft18">&#xe62e;</i></a>
          <?php endif; ?>
          ...
          <?php endif; ?>
               ...
               <a href="javascript:void(0);"  class=" vi-blue vi-blue " onclick="return _asr.loadData( '<?php echo "$funcid"; ?>' ,'<?php echo U("TempletSummary/index?func=detail&id=$master[id]") ; ?>',this, 'detail' ); "><i class="iconfont abe-ft18">&#xe61e;</i></a></td>


                                  <td style=" <?php if(isset($colshow["status"]) && $colshow["status"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Templet_status("$master[status]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["templet_no"]) && $colshow["templet_no"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><a href="javascript:void(0);" class="vi-blue"  onclick="return _asr.openLink('<?php echo U("/Home/Templet/index?func=view&id=$master[id]"); ?>','<?php echo filterFuncId( U("/Home/Templet/index?func=view&id=$master[id]") ,"");?>', '组卷模板详情' ,0); " ><?php echo $master["templet_no"] ; ?></a></td>
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " ><?php echo get_table_Templet_type("$master[type]","name","") ; ?></td>
                                  <td style=" <?php if(isset($colshow["subject"]) && $colshow["subject"]=="0"): ?>display:none<?php endif; ?> " class=" abe-txtl "><div class="newline"><?php echo OverView($master["subject"],100,"...") ; ?></div></td>
    ...
    <?php echo W('Summary/javascript',array('TempletSummary'));?>
