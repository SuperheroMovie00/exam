      ...
      <div class="list-scroll">
        <div class="table-box">
          ...
          <!-- 序号        <col style="width: 40px ;">   -->
                           ...
                           <col style="width: 100px ; <?php if(isset($colshow["value"]) && $colshow["value"]=="0"): ?>display:none;<?php endif; ?> ">
          ...
          <!-- 序号       <th>序号</th>   -->
                          ...
                          <th <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">类型</th>
                          ...
                          <th <?php if(isset($colshow["remarks"]) && $colshow["remarks"]=="0"): ?> style="display:none" <?php endif; ?> class="abe-txtl">说明</th>
          ...
          <?php endif; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["type"]) && $colshow["type"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><?php echo get_table_SystemParameter_type("$master[type]","name","") ; ?></td>
                                  ...
                                  <td style=" <?php if(isset($colshow["remarks"]) && $colshow["remarks"]=="0"): ?>display:none<?php endif; ?> " class="abe-txtl"><div><?php echo OverView($master["remarks"],100,"...") ; ?></div></td>
          ...
          <?php if ($master['status']=='0'): ?>
               <input type="button" value="转有效" class="btn btn-sm btn-blue mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/SystemParameter/index?func=status_on&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/SystemParameter/index?func=status_on&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?>
          <?php if (isset($rights['status_off']) && $rights['status_off']): ?>
          <?php if ($master['status']=='1'): ?>
               <input type="button" value="转无效" class="btn btn-sm btn-org mlg_10 " onclick="return _asr.popupFun('<?php echo U("/Home/SystemParameter/index?func=status_off&id=$master[id]") ; ?>', '<?php echo filterFuncId("/Home/SystemParameter/index?func=status_off&id=$master[id]","");?>'); " />
          <?php endif; ?>
          <?php endif; ?></td>
                                 <td></td>
                              </tr>
