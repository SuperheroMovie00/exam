...
//// source for add - begin ////
    private function add($data) {
       ...
       if($data['search']['req_category_code']){
          $ret=M( "question_category" )
               ...
               ->find();
          if($ret){
              $data["search"]["req_category_code_name"] = $ret["full_path"];
          }
       }
       //检查绑定赋值
    ...
    private function save($data) {
       ...
       if(!$type)
       {
           ...
           if(!$req_unit) $this->ajaxError("试题分类 不能为空");
           ...
           if($req_category_code){
               ...
               $req_category_code_name = $ret['name'];
           }
