...
class HolterOrigOfflineModel extends Model{
    protected $tableName = 'holter_orig_offline';
...
//        print_r($startTime.','.$times.','.$startPos.','.$step);exit();
    ...
    public function origdata_readfile($filterFilePath,$dataFilePath,$startTime,$times){
