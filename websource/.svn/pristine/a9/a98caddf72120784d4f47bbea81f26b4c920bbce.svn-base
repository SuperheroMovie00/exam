    ...
    private function search($data) {
       ...
       if($bsearch) {
           ...
           if($search["_showsearch"]=="hide"  ){
               ...
               $condition_system_parameter = join_condition($condition_system_parameter,"@system_parameter.remarks",$search["remarks"],"char","both");
           }
           ...
           $selectfields.=", @system_parameter.remarks ";
