    ...
    private function search($data) {
       ...
       if($bsearch) {
           ...
           if($search["_showsearch"]=="hide"  ){
               ...
               $condition_role = join_condition($condition_role,"@role.name",$search["name"],"char");
               $condition_role = join_condition($condition_role,"@role.remark",$search["remark"],"char","both");
           }
